...
- [Paper List](#paper-list)
  ...
  - [Harness Agents and Context Engineering](#harness-agents-and-context-engineering)
  - [Skills and Skill Libraries](#skills-and-skill-libraries)
  - [Memory and Experience](#memory-and-experience)
  - [Execution Environments and Benchmarks](#execution-environments-and-benchmarks)
...
This section is generated from `papers.bib`, the LaTeX manuscript citations, and the chapter `context_library.md` files. It currently includes **514 unique entries**: 386 unique BibTeX entries from 402 raw BibTeX records, plus 128 additional chapter-library candidates not already covered by title or URL.

Rows without a Paper or Github badge are retained when the manuscript already cites the work but the public source URL still needs verification; those entries are marked with `citation-gap` in `papers.bib`.
...
| 2026-04 | `rdi_agentx_agentbeats2026` | AgentX-AgentBeats Competition | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://rdi.berkeley.edu/agentx-agentbeats) | - |
...
| 2026-04 | `ge2026syntheticcomputers` | Synthetic Computers at Scale for Long-Horizon Productivity Simulation | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.28181) | - |
...
| 2025-08 | `Edge General Intelligence` | Edge General Intelligence Through World Models and Agentic AI: Fundamentals, Solutions, and Challenges | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.09561) | - |
| 2025-08 | `Large VLM-based Vision-Language-Action` | Large VLM-based Vision-Language-Action Models for Robotic Manipulation: A Survey | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.13073) | - |
...
| 2025-07 | `Large Language Model` | Large Language Model Powered Intelligent Urban Agents: Concepts, Capabilities, and Applications | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.00914) | - |
...
| 2025-04 | `Beyond Single-Turn` | Beyond Single-Turn: A Survey on Multi-Turn Interactions with Large Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.04717) | - |
| 2025-04 | `From Human Memory to AI Memory` | From Human Memory to AI Memory: A Survey on Memory Mechanisms in the Era of LLMs | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.15965) | - |
| 2025-04 | `LLMs Working in Harmony` | LLMs Working in Harmony: A Survey on the Technological Aspects of Building Effective LLM-Based Multi Agent Systems | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.01963) | - |
...
| 2025-04 | `The Dream Within Huang Long Cave` | The Dream Within Huang Long Cave: AI-Driven Interactive Narrative for Family Storytelling and Emotional Reflection | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.04968) | - |
...
| 2024-07 | `Agentless` | Agentless: Demystifying LLM-based Software Engineering Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2407.01489) | - |
...
| 2024-01 | `tong2024eyes` | Eyes wide shut? exploring the visual shortcomings of multimodal llms | - | - |
| 2023-12 | `Towards Efficient Generative` | Towards Efficient Generative Large Language Model Serving: A Survey from Algorithms to Systems | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2312.15234) | - |
| 2023-11 | `Advancing Transformer Architecture` | Advancing Transformer Architecture in Long-Context Large Language Models: A Comprehensive Survey | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2311.12351) | - |
...
| 2023-01 | `HuggingGPT` | HuggingGPT: solving AI tasks with chatgpt and its friends in hugging face | - | - |
...
| 2026-03 | `ALARA for Agents` | ALARA for Agents: Least-Privilege Context Engineering Through Portable Composable Multi-Agent Teams | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.20380) | - |
...
| 2026-03 | `Plan-Aware Automated Context` | Plan-Aware Automated Context Engineering | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=WrgtPmUNtn) | - |
| 2026-02 | `Codified Context` | Codified Context: Infrastructure for AI Agents in a Complex Codebase | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.20478) | - |
...
| 2026-01 | `Agentic Context Engineering` | Agentic Context Engineering: Evolving Contexts for Self-Improving Language Models | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=eC4ygDs02R) | - |
...
| 2025-10 | `Scaling LLM Multi-turn` | Scaling LLM Multi-turn RL with End-to-end Summarization-based Context Management | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.06727) | - |
| 2025-09 | `Alita-G` | Alita-G: Self-Evolving Generative Agent for Agent Generation | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=xf2JC4531b) | - |
| 2025-09 | `Building Learning Context` | Building Learning Context For Autonomous Agents Through Generative Optimization | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=wtLyksjIdl) | - |
| 2025-09 | `CEA` | CEA: Context Engineering Agent for Enhanced Reliability and Sustainability in Deep Research Systems | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=6QUNblHtto) | - |
| 2025-09 | `Efficient On-Device Agents` | Efficient On-Device Agents via Adaptive Context Management | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=TPXVdBjrvU) | - |
| 2025-09 | `Sandbox-RL` | Sandbox-RL: Scalable Multi-LLMs Optimization through Sandbox-Based Reinforcement Learning | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=0pFcKF2li1) | - |
| 2025-09 | `WebOperator` | WebOperator: Action-Aware Tree Search for Autonomous Agents in Web Environment | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=vnEuxLVFmN) | - |
...
| 2025-08 | `A Survey on` | A Survey on Agent Workflow -- Status and Future | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.01186) | - |
| 2025-08 | `Agentic AI Frameworks` | Agentic AI Frameworks: Architectures, Protocols, and Design Challenges | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.10146) | - |
| 2025-08 | `AgentScope 1.0` | AgentScope 1.0: A Developer-Centric Framework for Building Agentic Applications | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.16279) | - |
| 2025-08 | `Securing Agentic AI` | Securing Agentic AI: Threat Modeling and Risk Analysis for Network Monitoring Agentic AI System | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.10043) | - |
...
| 2025-07 | `MemTool` | MemTool: Optimizing Short-Term Memory Management for Dynamic Tool Calling in LLM Agent Multi-Turn Conversations | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.21428) | - |
| 2025-07 | `Thinking Beyond Tokens` | Thinking Beyond Tokens: From Brain-Inspired Intelligence to Cognitive Foundations for Artificial General Intelligence and its Societal Impact | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.00951) | - |
| 2025-06 | `Agentic ai and multiagentic` | Agentic ai and multiagentic: Are we reinventing the wheel? | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.01463) | - |
| 2025-06 | `Distinguishing Autonomous AI` | Distinguishing Autonomous AI Agents from Collaborative Agentic Systems: A Comprehensive Framework for Understanding Modern Intelligent Architectures | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.01438) | - |
...
| 2025-05 | `MemOS` | MemOS: An Operating System for Memory-Augmented Generation (MAG) in Large Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.22101) | - |
| 2025-04 | `Modeling Response Consistency` | Modeling Response Consistency in Multi-Agent LLM Systems: A Comparative Analysis of Shared and Separate Context Approaches | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.07303) | - |
| 2025-04 | `Planet as a Brain` | Planet as a Brain: Towards Internet of AgentSites based on AIOS Server | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.14411) | - |
| 2025-04 | `Task Memory Engine` | Task Memory Engine (TME): Enhancing State Awareness for Multi-Step LLM Agent Tasks | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.08525) | - |
...
| 2024-08 | `Agent q` | Agent q: Advanced reasoning and learning for autonomous ai agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2408.07199) | - |
...
| 2024-03 | `AIOS` | AIOS: LLM Agent Operating System | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2403.16971) | - |
| 2023-12 | `KwaiAgents` | KwaiAgents: Generalized information-seeking agent system with large language models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2312.04889) | - |
| 2023-12 | `LLM` | LLM as OS, Agents as Apps: Envisioning AIOS, Agents and the AIOS-Agent Ecosystem | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2312.03815) | - |
...
| 2026-04 | `From Multi-Agent to Single-Agent` | From Multi-Agent to Single-Agent: When Is Skill Distillation Beneficial? | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.01608) | - |
...
| 2026-04 | `SKILLFOUNDRY` | SKILLFOUNDRY: Building Self-Evolving Agent Skill Libraries from Heterogeneous Scientific Resources | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.03964) | - |
...
| 2026-03 | `humancertifiedmodules2026aiage` | Human-Certified Module Repositories for the AI Age | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.02512) | - |
...
| 2026-02 | `CODE-SHARP` | CODE-SHARP: Continuous Open-ended Discovery and Evolution of Skills as Hierarchical Reward Programs | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.10085) | - |
| 2026-02 | `selfconsolidation2026selfevolving` | Self-Consolidation for Self-Evolving Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.01966) | - |
...
| 2026-01 | `coevoskills2026_repo` | CoEvoSkills | [![Repo](https://img.shields.io/badge/Repo-000000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Zhang-Henry/CoEvoSkills) | [![GitHub Stars](https://img.shields.io/github/stars/Zhang-Henry/CoEvoSkills?style=for-the-badge&logo=github&label=GitHub&color=black)](https://github.com/Zhang-Henry/CoEvoSkills) |
| 2026-01 | `shi2026psn` | Evolving Programmatic Skill Networks | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2601.03509) | - |
...
| 2026-01 | `Knowledge is Not Enough` | Knowledge is Not Enough: Injecting RL Skills for Continual Adaptation | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2601.11258) | - |
| 2026-01 | `metacontext2026agenticskillevolution` | Meta Context Engineering via Agentic Skill Evolution | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2601.21557) | - |
...
| 2025-12 | `auditedskillgraph2025agentic` | Audited Skill-Graph Self-Improvement for Agentic LLMs via Verifiable Rewards, Experience Synthesis, and Continual Memory | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2512.23760) | - |
| 2025-12 | `CASCADE` | CASCADE: Cumulative Agentic Skill Creation through Autonomous Development and Evolution | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2512.23880) | - |
| 2025-12 | `rlposttraining2025skillcomposition` | How Does RL Post-training Induce Skill Composition? A Case Study on Countdown | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2512.01775) | - |
| 2025-12 | `hierarchicalproceduralmemory2025bayesian` | Learning Hierarchical Procedural Memory for LLM Agents through Bayesian Selection and Contrastive Refinement | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2512.18950) | - |
...
| 2025-12 | `Synthesizing Procedural Memory` | Synthesizing Procedural Memory: Challenges and Architectures in Automated Workflow Generation | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2512.20278) | - |
| 2025-11 | `SkillGen` | SkillGen: Learning Domain Skills for In-Context Sequential Decision Making | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2511.14670) | - |
...
| 2025-10 | `WALT` | WALT: Web Agents that Learn Tools | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.01524) | - |
| 2025-09 | `Empowering LLMs with` | Empowering LLMs with Parameterized Skills for Adversarial Long-Horizon Planning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2509.13127) | - |
| 2025-09 | `SkillEvo` | SkillEvo: An Experience Learning Framework with Reinforcement Learning for Skill Evolution | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=S1cIE9pe3k) | - |
| 2025-04 | `Inducing Programmatic Skills` | Inducing Programmatic Skills for Agentic Tasks | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.06821) | - |
| 2025-04 | `SkillWeaver` | SkillWeaver: Web Agents can Self-Improve by Discovering and Honing Skills | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.07079) | - |
| 2024-12 | `zhou2024pae` | Proposer-Agent-Evaluator(PAE): Autonomous Skill Discovery For Foundation Model Internet Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2412.13194) | - |
...
| 2023-02 | `Toolformer` | Toolformer: Language Models Can Teach Themselves to Use Tools | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2302.04761) | - |
...
| 2026-05 | `RubricEM` | RubricEM: Meta-RL with Rubric-guided Policy Decomposition beyond Verifiable Rewards | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2605.10899) | - |
...
| 2026-01 | `FadeMem` | FadeMem: Biologically-Inspired Forgetting for Efficient Agent Memory | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2601.18642) | - |
...
| 2026-01 | `REMem` | REMem: Reasoning with Episodic Memory in Language Agent | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=fugnQxbvMm) | - |
...
| 2025-10 | `CAM` | CAM: A Constructivist View of Agentic Memory for LLM-Based Reading Comprehension | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.05520) | - |
| 2025-10 | `Mnemosyne` | Mnemosyne: An Unsupervised, Human-Inspired Long-Term Memory Architecture for Edge-Based LLMs | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.08601) | - |
| 2025-10 | `TokMem` | TokMem: Tokenized Procedural Memory for Large Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.00444) | - |
| 2025-09 | `Look Back to Reason Forward` | Look Back to Reason Forward: Revisitable Memory for Long-Context LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2509.23040) | - |
| 2025-08 | `Long Story Generation` | Long Story Generation via Knowledge Graph and Literary Theory | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.03137) | - |
| 2025-08 | `Memory-Augmented Transformers` | Memory-Augmented Transformers: A Systematic Review from Neuroscience Principles to Enhanced Model Architectures | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.10824) | - |
| 2025-08 | `Multiple Memory Systems` | Multiple Memory Systems for Enhancing the Long-term Memory of Agent | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.15294) | - |
...
| 2025-08 | `Semantic Anchoring in` | Semantic Anchoring in Agentic Memory: Leveraging Linguistic Structures for Persistent Conversational Context | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.12630) | - |
| 2025-07 | `MemOS` | MemOS: A Memory OS for AI System | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.03724) | - |
...
| 2025-05 | `From Single to Multi-Granularity` | From Single to Multi-Granularity: Toward Long-Term Memory Association and Selection of Conversational Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.19549) | - |
| 2025-04 | `Mem0` | Mem0: Building Production-Ready AI Agents with Scalable Long-Term Memory | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.19413) | - |
| 2025-03 | `MemInsight` | MemInsight: Autonomous Memory Augmentation for LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2503.21760) | - |
...
| 2025-02 | `M+` | M+: Extending MemoryLLM with Scalable Long-Term Memory | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2502.00592) | - |
| 2025-02 | `R^3Mem: Bridging Memory` | R^3Mem: Bridging Memory Retention and Retrieval via Reversible Compression | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2502.15957) | - |
| 2025-02 | `TReMu` | TReMu: Towards Neuro-Symbolic Temporal Reasoning for LLM-Agents with Memory in Multi-Session Dialogues | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2502.01630) | - |
| 2025-01 | `Episodic Memory in` | Episodic Memory in AI Agents Poses Risks that Should be Studied and Mitigated | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2501.11739) | - |
...
| 2024-07 | `AriGraph` | AriGraph: Learning Knowledge Graph World Models with Episodic Memory for LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2407.04363) | - |
| 2024-05 | `WISE` | WISE: Rethinking the Knowledge Memory for Lifelong Model Editing of Large Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2405.14768) | - |
...
| 2024-04 | `MemLLM` | MemLLM: Finetuning LLMs to Use An Explicit Read-Write Memory | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2404.11672) | - |
...
| 2024-02 | `Memoryllm` | Memoryllm: Towards self-updatable large language models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2402.04624) | - |
...
| 2023-04 | `Unleashing infinite-length input` | Unleashing infinite-length input capacity for large-scale language models with self-controlled memory system | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2304.13343) | - |
...
| 2022-12 | `A machine with` | A machine with short-term, episodic, and semantic memory systems | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2212.02098) | - |
...
| 2018-01 | `chaudhry2018rwalk` | Riemannian Walk for Incremental Learning: Understanding Forgetting and Intransigence | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/1801.10112) | - |
...
| 2026-02 | `MCP-Atlas` | MCP-Atlas: A Large-Scale Benchmark for Tool-Use Competency with Real MCP Servers | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.00933) | - |
...
| 2026-01 | `gwscli2026_repo` | Google Workspace CLI (gws) | [![Repo](https://img.shields.io/badge/Repo-000000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/googleworkspace/cli) | [![GitHub Stars](https://img.shields.io/github/stars/googleworkspace/cli?style=for-the-badge&logo=github&label=GitHub&color=black)](https://github.com/googleworkspace/cli) |
...
| 2025-10 | `Watch and Learn` | Watch and Learn: Learning to Use Computers from Online Videos | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.04673) | - |
| 2025-09 | `ATLAS` | ATLAS: Actor-Critic Task-Completion with Look-ahead Action Simulation | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=hwwn9hAAo5) | - |
| 2025-09 | `BuildBench` | BuildBench: Benchmarking LLM Agents on Compiling Real-World Open-Source Software | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2509.25248) | - |
| 2025-09 | `Dynamic ReAct` | Dynamic ReAct: Scalable Tool Selection for Large-Scale MCP Environments | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2509.20386) | - |
| 2025-06 | `Go-Browse` | Go-Browse: Training Web Agents with Structured Exploration | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.03533) | - |
| 2025-05 | `Get Experience from Practice` | Get Experience from Practice: LLM Agents with Record & Replay | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.17716) | - |
...
| 2024-11 | `AutoGLM` | AutoGLM: Autonomous Foundation Agents for GUIs | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2411.00820) | - |
| 2024-10 | `Beyond Browsing` | Beyond Browsing: API-Based Web Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2410.16464) | - |
| 2024-10 | `Web Agents with World Models` | Web Agents with World Models: Learning and Leveraging Environment Dynamics in Web Navigation | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2410.13232) | - |
| 2024-05 | `Workbench` | Workbench: a benchmark dataset for agents in a realistic workplace setting | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2405.00823) | - |
...
| 2024-01 | `Visualwebarena` | Visualwebarena: Evaluating multimodal agents on realistic visual web tasks | - | - |
...
| 2026-05 | `cheng2025agentr1` | Agent-R1 | - | - |
| 2026-05 | `li2025agentflow` | AgentFlow | - | - |
| 2026-05 | `xi2025agentgymrl` | AgentGym-RL | - | - |
| 2026-05 | `li2025chainofagents` | Chain of Agents | - | - |
| 2026-05 | `anthropic2026opus47` | Claude Opus 4.7 | - | - |
| 2026-05 | `COPD` | COPD | - | - |
| 2026-05 | `deepseekai2025deepseekv32` | DeepSeek-V3.2 | - | - |
| 2026-05 | `ERNIE` | ERNIE 5.0 | - | - |
...
| 2026-05 | `googledeepmind2026gemini35flash` | Gemini 3.5 Flash | - | - |
...
| 2026-05 | `GLM-4.5` | GLM-4.5 | - | - |
| 2026-05 | `GLM-5` | GLM-5 | - | - |
| 2026-05 | `GLM-5.1` | GLM-5.1 | - | - |
| 2026-05 | `GPT-5.5` | GPT-5.5 | - | - |
| 2026-05 | `hu2025himaecom` | HiMA-Ecom | - | - |
| 2026-05 | `li2026katcoderv2` | KAT-Coder-V2 | - | - |
| 2026-05 | `kimi2025k2` | Kimi K2 | - | - |
| 2026-05 | `kimi2026k25` | Kimi K2.5 | - | - |
| 2026-05 | `ji2026actionguidance` | Learning Agentic Policy from Action Guidance | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2605.12004) | - |
| 2026-05 | `golubev2025longcontextswe` | Long-Context SWE Reinforcement Learning | - | - |
| 2026-05 | `chen2025longhorizonida` | Long-Horizon Interactive Decision Agents | - | - |
| 2026-05 | `M2RL` | M2RL | - | - |
| 2026-05 | `xiaomi2026mimov2flash` | MiMo-V2-Flash | - | - |
| 2026-05 | `xiaomi2025mimovl` | MiMo-VL | - | - |
| 2026-05 | `minimax2026m27` | MiniMax M2.7 | - | - |
| 2026-05 | `yang2026nemotroncascade2` | Nemotron-Cascade 2 | - | - |
| 2026-05 | `qwen2025qwen3` | Qwen3 | - | - |
| 2026-05 | `qwen2026codernext` | Qwen3-Coder-Next | - | - |
| 2026-05 | `li2026rethinkingopd` | Rethinking On-Policy Distillation | - | - |
| 2026-05 | `cheng2025revisitingcrossdomainrl` | Revisiting Cross-Domain Reinforcement Learning | - | - |
| 2026-05 | `zhang2025routerr1` | Router-R1 | - | - |
| 2026-05 | `shang2025rstar2agent` | rStar2-Agent | - | - |
| 2026-05 | `song2026opdsurvey` | Survey of On-Policy Distillation | - | - |
| 2026-05 | `wang2025swedev` | SWE-Dev | - | - |
| 2026-05 | `su2025toolorchestra` | ToolOrchestra | - | - |
...
| 2026-05 | `qian2025xrouter` | xRouter | - | - |
...
| 2026-02 | `CM2` | CM2: Reinforcement Learning with Checklist Rewards for Multi-Turn and Multi-Step Agentic Tool Use | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.12268) | - |
| 2026-02 | `How to Train` | How to Train Your Deep Research Agent? Prompt, Reward, and Policy Optimization in Search-R1 | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.19526) | - |
...
| 2026-01 | `Reinforcement Learning for` | Reinforcement Learning for Machine Learning Engineering Agents | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=mfIbSouoaZ) | - |
| 2026-01 | `Scaling Agent Learning` | Scaling Agent Learning via Experience Synthesis | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=cf7qpBwttr) | - |
...
| 2025-11 | `DR Tulu` | DR Tulu: Reinforcement Learning with Evolving Rubrics for Deep Research | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2511.19399) | - |
...
| 2025-10 | `EARL` | EARL: Efficient Agentic Reinforcement Learning Systems for Large Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.05943) | - |
| 2025-10 | `In-the-Flow Agentic System` | In-the-Flow Agentic System Optimization for Effective Planning and Tool Use | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.05592) | - |
| 2025-09 | `Agent Learning via` | Agent Learning via Early Experience | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=pEGnJbmSUy) | - |
| 2025-09 | `Enhancing Offline-to-Online Reinforcement` | Enhancing Offline-to-Online Reinforcement Learning by Adaptive Experience Aligned Diffusion Sampling | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=1UFcZrQp5w) | - |
| 2025-09 | `EvoAgent` | EvoAgent: Self-evolving Agent with Continual World Model for Long-Horizon Tasks | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=WSkU78RTGC) | - |
| 2025-09 | `JoyAgents-R1` | JoyAgents-R1: Accelerating Multi-Agent Evolution Dynamics with Variance-Reduction Group Relative Policy Optimization | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=U7n8gZGyAu) | - |
| 2025-09 | `ML-Agent` | ML-Agent: Reinforcing LLM Agents for Autonomous Machine Learning Engineering | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=AEgyitdRWf) | - |
| 2025-09 | `Safe In-Context Reinforcement` | Safe In-Context Reinforcement Learning | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=F8a6dAw3Yg) | - |
...
| 2025-09 | `Training a Vision-Language` | Training a Vision-Language Model for Diverse Exploration in Open GUI World | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=IljH2Bt6jO) | - |
...
| 2025-08 | `ALAS` | ALAS: Autonomous Learning Agent for Self-Updating Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.15805) | - |
| 2025-08 | `Chain-of-agents` | Chain-of-agents: End-to-end agent foundation models via multi-agent distillation and agentic rl | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.13167) | - |
...
| 2025-08 | `ParallelSearch` | ParallelSearch: Train your LLMs to Decompose Query and Search Sub-queries in Parallel with Reinforcement Learning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.09303) | - |
| 2025-07 | `SWE-Bench-CL` | SWE-Bench-CL: Continual Learning for Coding Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.00014) | - |
| 2025-06 | `JoyAgents-R1` | JoyAgents-R1: Joint Evolution Dynamics for Versatile Multi-LLM Agents with Reinforcement Learning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.19846) | - |
| 2025-06 | `Self-correcting Reward Shaping` | Self-correcting Reward Shaping via Language Models for Reinforcement Learning Agents in Games | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.23626) | - |
| 2025-05 | `A Snapshot of Influence` | A Snapshot of Influence: A Local Data Attribution Framework for Online Reinforcement Learning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.19281) | - |
...
| 2025-05 | `Agentic reasoning and` | Agentic reasoning and tool integration for llms via reinforcement learning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.01441) | - |
| 2025-05 | `ARPO` | ARPO:End-to-End Policy Optimization for GUI Agents with Experience Replay | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.16282) | - |
| 2025-05 | `Group-in-Group Policy Optimization` | Group-in-Group Policy Optimization for LLM Agent Training | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.10978) | - |
...
| 2025-02 | `Reinforcement Learning for` | Reinforcement Learning for Long-Horizon Interactive LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2502.01600) | - |
...
| 2024-11 | `WebRL` | WebRL: Training LLM Web Agents via Self-Evolving Online Curriculum Reinforcement Learning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2411.02337) | - |
...
| 2019-04 | `vandeven2019scenarios` | Three scenarios for continual learning | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/1904.07734) | - |
...
| 2026-05 | `zhao2026expweaver` | Rethinking Experience Utilization in Self-Evolving Language Model Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2605.07164) | - |
...
| 2026-04 | `AlphaLab` | AlphaLab: Autonomous Multi-Agent Research Across Optimization Domains with Frontier LLMs | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.08590) | - |
...
| 2026-04 | `Memory Transfer Learning` | Memory Transfer Learning: How Memories are Transferred Across Domains in Coding Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.14004) | - |
...
| 2026-04 | `SEA-Eval` | SEA-Eval: A Benchmark for Evaluating Self-Evolving Agents Beyond Episodic Assessment | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.08988) | - |
...
| 2026-03 | `CodeScout` | CodeScout: Contextual Problem Statement Enhancement for Software Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.05744) | - |
| 2026-03 | `EffiSkill` | EffiSkill: Agent Skill Based Automated Code Efficiency Optimization | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.27850) | - |
| 2026-03 | `allard2026experientialreflective` | Experiential Reflective Learning for Self-Improving LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.24639) | - |
...
| 2026-03 | `ma2026rtsevolution` | Self-Evolving Multi-Agent Framework for Efficient Decision Making in Real-Time Strategy Scenarios | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.23875) | - |
...
| 2026-02 | `VeRO` | VeRO: An Evaluation Harness for Agents to Optimize Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.22480) | - |
...
| 2026-01 | `PACEvolve` | PACEvolve: Enabling Long-Horizon Progress-Aware Consistent Evolution | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2601.10657) | - |
| 2025-10 | `el2025inefficiencies` | Inefficiencies of Meta Agents for Agent Design | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.06711) | - |
| 2025-10 | `Orchestrating Human-AI Teams` | Orchestrating Human-AI Teams: The Manager Agent as a Unifying Research Challenge | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.02557) | - |
...
| 2026-04 | `carbench_agentbeats2026` | CAR-bench Evaluator - AgentBeats | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://agentbeats.dev/johanneskirmayr/car-bench-evaluator) | - |
...
| 2026-03 | `ASTRA-bench` | ASTRA-bench: Evaluating Tool-Use Agent Reasoning and Action Planning with Personal User Context | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.01357) | - |
| 2026-03 | `beyondpass12026` | Beyond pass@1: A Reliability Science Framework for Long-Horizon LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.29231) | - |
...
| 2026-02 | `Gaia2` | Gaia2: Benchmarking LLM Agents on Dynamic and Asynchronous Environments | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=9gw03JpKK4) | - |
...
| 2026-01 | `aecbench2026_repo` | AEC-Bench | [![Repo](https://img.shields.io/badge/Repo-000000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nomic-ai/aec-bench) | [![GitHub Stars](https://img.shields.io/github/stars/nomic-ai/aec-bench?style=for-the-badge&logo=github&label=GitHub&color=black)](https://github.com/nomic-ai/aec-bench) |
...
| 2026-01 | `Legacy-Bench` | Legacy-Bench: A Benchmark for AI Agents on Legacy Software Engineering Tasks | [![Repo](https://img.shields.io/badge/Repo-000000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/factory-ai/legacy-bench) | [![GitHub Stars](https://img.shields.io/github/stars/factory-ai/legacy-bench?style=for-the-badge&logo=github&label=GitHub&color=black)](https://github.com/factory-ai/legacy-bench) |
...
| 2025-10 | `MEMTRACK` | MEMTRACK: Evaluating Long-Term Memory and State Tracking in Multi-Platform Dynamic Agent Environments | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.01353) | - |
| 2025-10 | `TRAJECT-Bench` | TRAJECT-Bench:A Trajectory-Aware Benchmark for Evaluating Agentic Tool Use | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.04550) | - |
| 2025-09 | `AutoJudger` | AutoJudger: An Agent-Driven Framework for Efficient Benchmarking of MLLMs | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=ueh4YWLX4n) | - |
| 2025-09 | `CXMArena` | CXMArena: Unified Dataset to benchmark performance in realistic CXM Scenarios | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=HSWE9aceZb) | - |
| 2025-09 | `MemGUI-Bench` | MemGUI-Bench: Benchmarking Memory of Mobile GUI Agents in Dynamic Environments | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=7JT8yIPELM) | - |
| 2025-09 | `MMBench-GUI` | MMBench-GUI: Hierarchical Multi-Platform Evaluation Framework for GUI Agents | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=GQugc1J2kW) | - |
| 2025-09 | `Towards Personalized Deep Research` | Towards Personalized Deep Research: Benchmarks and Evaluations | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2509.25106) | - |
| 2025-08 | `cai2025ell` | Building Self-Evolving Agents via Experience-Driven Lifelong Learning: A Framework and Benchmark | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.19005) | - |
| 2025-08 | `CHBench` | CHBench: A Cognitive Hierarchy Benchmark for Evaluating Strategic Reasoning Capability of LLMs | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2508.11944) | - |
...
| 2025-07 | `TELEVAL` | TELEVAL: A Dynamic Benchmark Designed for Spoken Language Models in Chinese Interactive Scenarios | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.18061) | - |
| 2025-06 | `MemBench` | MemBench: Towards More Comprehensive Evaluation on the Memory of LLM-based Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.21605) | - |
| 2025-06 | `Mind2web 2` | Mind2web 2: Evaluating agentic search with agent-as-a-judge | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.21506) | - |
| 2025-06 | `WebChoreArena` | WebChoreArena: Evaluating Web Browsing Agents on Realistic Tedious Web Tasks | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.01952) | - |
| 2025-05 | `Benchmarking Abstract and` | Benchmarking Abstract and Reasoning Abilities Through A Theoretical Perspective | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.23833) | - |
...
| 2025-05 | `Web-Shepherd` | Web-Shepherd: Advancing PRMs for Reinforcing Web Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2505.15277) | - |
...
| 2024-10 | `NNetNav` | NNetNav: Unsupervised Learning of Browser Agents Through Environment Interaction in the Wild | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2410.02907) | - |
| 2024-10 | `ST-WebAgentBench` | ST-WebAgentBench: A Benchmark for Evaluating Safety and Trustworthiness in Web Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2410.06703) | - |
...
| 2024-04 | `Exploring Autonomous Agents` | Exploring Autonomous Agents through the Lens of Large Language Models: A Review | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2404.04442) | - |
...
| 2023-09 | `BAMBOO` | BAMBOO: A Comprehensive Benchmark for Evaluating Long Text Modeling Capacities of Large Language Models | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2309.13345) | - |
...
| 2020-01 | `Alfred` | Alfred: A benchmark for interpreting grounded instructions for everyday tasks | - | - |
...
| 2026-04 | `pachaar2026agentharness` | The Anatomy of an Agent Harness | - | - |
...
| 2026-03 | `Governed Memory` | Governed Memory: A Production Architecture for Multi-Agent Workflows | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2603.17787) | - |
...
| 2026-01 | `ARMs` | ARMs: Adaptive Red-Teaming Agent against Multimodal Models with Plug-and-Play Attacks | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=wQ4OykcxaV) | - |
| 2026-01 | `RedCodeAgent` | RedCodeAgent: Automatic Red-teaming Agent against Diverse Code Agents | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=IyIaAOihmZ) | - |
...
| 2025-10 | `Position` | Position: Privacy Is Not Just Memorization! | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2510.01645) | - |
...
| 2025-09 | `PSG-Agent` | PSG-Agent: Personality-Aware Safety Guardrail for LLM-based Agents | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=qRGKHBE5RY) | - |
| 2025-09 | `You Don't Have` | You Don't Have to Be the One Doing Evil! Locate a Scapegoat within Multi-Agent Systems for Executing Covert Attacks | [![OpenReview](https://img.shields.io/badge/OpenReview-8A2BE2?style=for-the-badge)](https://openreview.net/forum?id=plIRiWr6lO) | - |
...
| 2025-07 | `Security Challenges in` | Security Challenges in AI Agent Deployment: Insights from a Large Scale Public Competition | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2507.20526) | - |
...
| 2025-06 | `Trism for agentic ai` | Trism for agentic ai: A review of trust, risk, and security management in llm-based agentic multi-agent systems | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2506.04133) | - |
...
| 2025-04 | `CheatAgent` | CheatAgent: Attacking LLM-Empowered Recommender Systems via LLM Agent | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2504.13192) | - |
...
| 2025-01 | `hendrycks2025hle` | Humanity's Last Exam | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2501.14249) | - |
...
| 2024-06 | `AgentDojo` | AgentDojo: A Dynamic Environment to Evaluate Prompt Injection Attacks and Defenses for LLM Agents | [![Paper](https://img.shields.io/badge/Paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2406.13352) | - |
